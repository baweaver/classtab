...
This is a generated version of the [original](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) with a few niceties I tend to like to have along for the ride, such as:

* Bootstrap
* Bootstrap UI
* Fontawesome

The thinking is that these libraries can be a mild pain to set up, and you have better things to do than trying
to make them all play nice. Have fun!

The rest of the README was left the same below this line.
